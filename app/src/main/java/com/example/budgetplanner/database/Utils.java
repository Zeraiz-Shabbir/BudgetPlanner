...
import static com.example.budgetplanner.WarningDialogManager.showWarningDialog;
...
//        }
        ...
        switch (e.getSource()) {
            ...
            case INSERT_STATEMENT:
                dialogMessage += removeStmt;
                showWarningDialog(context, dialogMessage, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // CALCULATE_BUDGETING or INSERT_STATEMENT
                        dialog.dismiss();
                    }
                });
                break;
